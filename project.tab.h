...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    TOK_READ = 259,                /* TOK_READ  */
    TOK_ERROR = 260,               /* TOK_ERROR  */
    TOK_GHILIMEA = 261,            /* TOK_GHILIMEA  */
    TOK_RETURN = 262,              /* TOK_RETURN  */
    TOK_SINGLE = 263,              /* TOK_SINGLE  */
    TOK_MULTI = 264,               /* TOK_MULTI  */
    TOK_IF = 265,                  /* TOK_IF  */
    TOK_ELSE = 266,                /* TOK_ELSE  */
    TOK_WHILE = 267,               /* TOK_WHILE  */
    TOK_INT = 268,                 /* TOK_INT  */
    TOK_DOUBLE = 269,              /* TOK_DOUBLE  */
    TOK_FLOAT = 270,               /* TOK_FLOAT  */
    TOK_ID = 271,                  /* TOK_ID  */
    TOK_FUNC = 272,                /* TOK_FUNC  */
    ...
    TOK_LE = 278,                  /* TOK_LE  */
    INT_VAL = 279,                 /* INT_VAL  */
    FLOAT_VAL = 280,               /* FLOAT_VAL  */
    DOUBLE_VAL = 281               /* DOUBLE_VAL  */
  };
